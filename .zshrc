...
alias vps='ssh -i ~/.ssh/vps root@nl'
alias vps1='ssh -i ~/.ssh/vps root@us'
alias acp='advcp -g'
alias listen='netstat -tulpn | grep LISTEN'
alias stdk='sudo ln -s /etc/runit/sv/docker /run/runit/service/ > /dev/null'
alias spdk='sudo sv stop docker > /dev/null && sudo rm -r /run/runit/service/docker'
alias sshkeys='eval $(ssh-agent -s) && ssh-add ~/.ssh/git ~/.ssh/vps'
alias connect='sudo connmanctl connect wifi_38baf8144e66_6c6170746f70_managed_psk'
alias disconnect='sudo connmanctl disconnect wifi_38baf8144e66_6c6170746f70_managed_psk'
alias ls='exa'
alias cat='bat'
